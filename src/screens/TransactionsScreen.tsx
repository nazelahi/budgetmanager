...
const TransactionsScreen: React.FC = () => {
  ...
  const handleDeleteTransaction = (transaction: Transaction) => {
    // Immediately delete and toast; if confirmation needed, implement a custom modal later
      ...
      <View style={styles.transactionLeft}>
        <View
          style={[
            ...
            {
              backgroundColor:
                getCategoryDetails(item.category, data.categories).color + "20",
              borderColor:
                getCategoryDetails(item.category, data.categories).color + "40",
            },
          ]}
        >
          <Ionicons
            name={
              getCategoryDetails(item.category, data.categories).icon as any
            }
            size={16}
