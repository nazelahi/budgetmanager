...
const SmartSuggestionsScreen: React.FC = () => {
  ...
  const loadSuggestions = async () => {
    try {
      ...
      ToastService.error("Error", "Failed to load smart suggestions");
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleDismissSuggestion = async (suggestionId: string) => {
    try {
      ...
      ToastService.error("Error", "Failed to dismiss suggestion");
    }
  };
          ...
          <View style={styles.suggestionLeft}>
            ...
            <View style={styles.suggestionInfo}>
              <View style={styles.suggestionHeader}>
                ...
                >
                  <Text
                    style={[styles.priorityText, { color: suggestionColor }]}
                  >
                    {priorityLabel}
                  </Text>
                </View>
              ...
              {suggestion.actionable && (
                <TouchableOpacity
                  ...
                  onPress={() => {
                    ...
                    if (
                      suggestion.type === "reduce_spending" ||
  ...
  const renderEmptyState = () => (
    <Animated.View entering={FadeIn.delay(200)} style={styles.emptyState}>
      ...
      <Text style={styles.emptyDescription}>
        Smart suggestions will appear here based on your budget performance and
        spending patterns
      </Text>
    </Animated.View>
  );
