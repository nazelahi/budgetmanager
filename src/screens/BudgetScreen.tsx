...
const BudgetScreen: React.FC = () => {
  ...
  const handleSaveBudget = async () => {
    ...
    try {
      ...
      if (!category) {
        ToastService.error("Error", "Category not found");
        return;
      }
      ...
      if (showEditModal && selectedBudget) {
        ...
        ToastService.success("Success", "Budget updated successfully");
      } else {
        await StorageService.addBudget(budgetData);
        ToastService.success("Success", "Budget created successfully");
      }
      ...
      ToastService.error("Error", "Failed to save budget");
    }
  };
    ...
    ToastService.confirm(
      ...
      async () => {
        try {
          ...
          await refreshData();
          await loadBudgetData();
          ToastService.success("Success", "Budget deleted successfully");
        } catch (error) {
          ToastService.error("Error", "Failed to delete budget");
        }
      },
    );
  };
    ...
    <View style={styles.container}>
      ...
      >
              ...
              <View style={styles.summaryHeader}>
                ...
                <View
                  style={[
                    ...
                    {
                      backgroundColor: budgetStats.isOverBudget
                        ? colors.error + "20"
                        : colors.primary + "20",
                    },
                  ]}
                >
                  <Ionicons
                    name={
                      budgetStats.isOverBudget ? "warning" : "checkmark-circle"
                    }
                    size={16}
                    color={
                      budgetStats.isOverBudget ? colors.error : colors.primary
                    }
                  />
                  <Text
                    style={[
                      ...
                      {
                        color: budgetStats.isOverBudget
                          ? colors.error
                          : colors.primary,
                      },
                    ]}
        ...
        <Animated.View
          ...
          style={styles.budgetListContainer}
        >
          ...
          {budgets.length === 0 ? (
            ...
            budgets.map((budget, index) => {
              const categoryStats = budgetStats?.categories.find(
                      ...
                      <View style={styles.categoryOptionInfo}>
                        <Text
                          style={[
                            ...
                            formData.categoryId === category.id &&
                              styles.categoryOptionNameSelected,
                          ]}
                        >
                          {category.name}
                        </Text>
                        <Text
                          style={[
                            styles.categoryOptionType,
                            formData.categoryId === category.id &&
                              styles.categoryOptionTypeSelected,
                          ]}
                        >
            ...
            <View style={styles.periodToggle}>
              ...
              >
                <Ionicons
                  ...
                  size={16}
                  color={
                    formData.period === "yearly" ? colors.white : colors.primary
                  }
                />
                <Text
                  style={[
          ...
          <Animated.View entering={SlideInUp.delay(400)} style={styles.section}>
            <View style={styles.inputContainer}>
              ...
              <Switch
                ...
                thumbColor={
                  formData.isActive ? colors.white : colors.textSecondary
                }
