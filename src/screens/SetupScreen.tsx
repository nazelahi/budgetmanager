  ...
  const handleComplete = async () => {
    ...
    try {
      ...
      if (selectedCategories.length === 0) {
        const defaultExpenseCategories = defaultCategories
          .filter((c) => c.type === "expense")
          .slice(0, 5);
        const defaultIncomeCategories = defaultCategories
      ...
      // Wait a moment for all data to be processed and refreshed
        ...
        return (
          ...
          >
            ...
            <Text style={styles.stepDescription}>
              Let's set up your personal budget management system in just a few
              steps. We'll help you organize your finances and track your
              spending habits.
            </Text>
          ...
          >
                      ...
                      <View style={styles.currencyListInfo}>
                        <Text
                          style={[
                            ...
                            currency === curr.code &&
                              styles.currencyListNameSelected,
                          ]}
                        >
                          {curr.name}
                        </Text>
                        <Text
                          style={[
                            ...
                            currency === curr.code &&
                              styles.currencyListCountrySelected,
                          ]}
                        >
                          {curr.country}
                        </Text>
                    ...
                    <View style={styles.currencyListRight}>
                      <Text
                        style={[
                          ...
                          currency === curr.code &&
                            styles.currencyListSymbolSelected,
                        ]}
                      >
                        {curr.symbol}
                      </Text>
                      <Text
                        style={[
                          ...
                          currency === curr.code &&
                            styles.currencyListCodeSelected,
                        ]}
                      >
                        {curr.code}
                      </Text>
            ...
            {currency && (
              <Animated.View
                ...
                style={styles.selectedCurrencyInfo}
              >
          ...
          >
            {selectedCategories.length === 0 ? (
              <View style={styles.placeholderContainer}>
                ...
                <Text style={styles.placeholderSubtext}>
                  Choose from the list below (optional)
                </Text>
              </View>
            ) : null}
                      ...
                      <View style={styles.categoryListInfo}>
                        <Text
                          style={[
                            ...
                            selectedCategories.includes(category.name) &&
                              styles.categoryListNameSelected,
                          ]}
                        >
                          {category.name}
                        </Text>
                        <Text
                          style={[
                            ...
                            selectedCategories.includes(category.name) &&
                              styles.categoryListTypeSelected,
                          ]}
                        >
      ...
      case 5:
        return (
          ...
          >
            ...
            <Text style={styles.stepDescription}>
              Your budget manager is ready to use. You can now start tracking
            ...
            <View style={styles.completeFeatures}>
              <View style={styles.completeFeature}>
                ...
                <Text style={styles.completeFeatureText}>
