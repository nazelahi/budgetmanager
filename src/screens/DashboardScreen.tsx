...
const DashboardScreen: React.FC = () => {
  ...
  const handleDeleteTransaction = (transaction: any) => {
    ...
    ToastService.success("Deleted", "Transaction deleted");
  };
            ...
            <View style={styles.headerActions}>
              ...
              >
                <TouchableOpacity
                  ...
                  onPress={() =>
                    (navigation as any).navigate("AlertsDashboard")
                  }
                >
                  <Ionicons
                ...
                <View style={styles.summaryCardContent}>
                  ...
                  <View style={styles.summaryInfo}>
                    ...
                    <Text style={styles.summaryValue}>
                      {formatCurrency(getMonthlyStats().income)}
                    </Text>
                  </View>
                </View>
              </AnimatedCard>
              ...
              <AnimatedCard style={styles.summaryCard}>
                <View style={styles.summaryCardContent}>
                  ...
                  <View style={styles.summaryInfo}>
                    ...
                    <Text style={styles.summaryValue}>
                      {formatCurrency(getMonthlyStats().expenses)}
                    </Text>
                  </View>
                </View>
              </AnimatedCard>
              ...
              <AnimatedCard style={styles.summaryCard}>
                <View style={styles.summaryCardContent}>
                  ...
                  <View style={styles.summaryInfo}>
                    ...
                    <Text style={styles.summaryValue}>
                      {formatCurrency(getMonthlyStats().balance)}
                    </Text>
                  </View>
                </View>
              </AnimatedCard>
          ...
          >
            ...
            >
              <Ionicons
                ...
                size={16}
                color={
                  activeTab === "budget" ? colors.white : colors.textSecondary
                }
              />
              <Text
                style={[
            ...
            >
              {recentTransactions.length > 0 ? (
                recentTransactions.map((transaction, index) => (
                  ...
                  >
                    <AnimatedCard style={styles.transactionCardInner}>
                      <TouchableOpacity
