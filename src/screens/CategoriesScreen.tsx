...
const CategoriesScreen: React.FC = () => {
  ...
  const handleSaveCategory = async () => {
    ...
    if (!validation.isValid) {
      ToastService.error(
        "Invalid Category",
        validation.errors[0] || "Please check your inputs",
      );
      return;
    }
    ...
    try {
      ...
      ToastService.error("Error", "Failed to save category");
    } finally {
      setSaving(false);
    }
  };
  ...
  const handleDeleteCategory = (category: Category) => {
    // Immediate delete with toast. Add confirm modal if needed.
    deleteCategory(category.id);
    ToastService.success("Category Deleted", `"${category.name}" removed`);
  };
            ...
            <View style={styles.typeButtons}>
              ...
              >
                <Ionicons
                  ...
                  size={20}
                  color={
                    categoryType === "expense" ? colors.white : colors.error
                  }
                />
                <Text
                  style={[
              ...
              >
                <Ionicons
                  ...
                  size={20}
                  color={
                    categoryType === "income" ? colors.white : colors.success
                  }
                />
                <Text
                  style={[
