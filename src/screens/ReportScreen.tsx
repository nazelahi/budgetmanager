...
const ReportScreen: React.FC = () => {
  ...
  const calculateYearlyStats = () => {
    ...
    const monthlyData = Array.from({ length: 12 }, (_, month) => {
      const monthTransactions = yearlyTransactions.filter(
      ...
      return {
        month: new Date(2024, month).toLocaleDateString("en-US", {
          month: "short",
        }),
        income: monthIncome,
  ...
  const generateCSV = () => {
    if (!reportData)
      return "Month,Income,Expenses,Balance,Transaction Count\nNo data available";
            ...
            {reportData.monthlyData.map((month: any, index: number) => (
              ...
              >
                ...
                <View style={styles.monthStats}>
                  ...
                  <Text style={styles.monthExpenses}>
                  ...
                  <Text
                    style={[
                      ...
                      {
                        color:
                          month.balance >= 0 ? colors.primary : colors.error,
                      },
                    ]}
                  >
