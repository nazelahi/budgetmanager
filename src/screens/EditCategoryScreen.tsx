...
const EditCategoryModal: React.FC<EditCategoryModalProps> = ({
  ...
  const handleSave = async () => {
    if (!name.trim()) {
      ToastService.error("Error", "Please enter a category name");
      return;
    }
    ...
    try {
      ...
      ToastService.success("Success", "Category updated successfully");
      handleClose();
    } catch (error) {
      ToastService.error("Error", "Failed to update category");
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleDelete = async () => {
    try {
      ...
      ToastService.success("Success", "Category deleted successfully");
      handleClose();
    } catch (error) {
      ToastService.error("Error", "Failed to delete category");
    }
  };
